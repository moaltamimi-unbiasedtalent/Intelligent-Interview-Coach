...
| P/share Explicit sharing | DELIVERED | Explicit, allow-listed | `share_grants` (report/story/prep-summary, VIEW); owner+member verified | `eval_workspace_security.py` | report/prep loaders are pluggable seams; story wired |
