...
| EX-02 | C1 realtime speech | Not run | Actual streaming round trip, interruption, silence, timeout, reconnect and recorded/text fallback; no duplicate/stale answer commit or post-logout capture |
